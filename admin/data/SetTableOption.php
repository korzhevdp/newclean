...
if(!Users::isAdmin($arUser['group_id']))
	exit('Извините, у вас недостаточно прав доступа к данному разделу. Панель настроек ещё на стадии разработки.');
...
if($errorIndex==1) exit('При попытке обработки введённых данных произошла ошибка.');
