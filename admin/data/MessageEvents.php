...
{
	exit('<div class="pg10px">Извините, у Вас недостаточно прав доступа к данному разделу.  Панель настроек на стадии разработки и доступна только системным администраторам</div>');
}
...
<div class="table header">
	<div class="table-row">
		...
		<div style="width: 20%;" data-field="text" data-required>Текст письма</div>
