...
echo "<div class='line-caption'>Общая статистика по районам города<i>Показатели отражают полную статистику обработки сообщений по территориальной принадлежности</i></div>";
$index = 0;
