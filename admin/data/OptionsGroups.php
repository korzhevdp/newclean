...
<div class="table header">
	<div class="table-row">
		...
		<div style="width: 15%;" data-field="caption" data-required>Надпись для пользователя</div>
		...
		<div style="width: 6%;" data-field="law4_1" title="Возможность назначать департамент">
			<span>LW4_1</span>
			<div class="hidden-select" id="law_4_1_select">
				<select>
					<option value='0'>Нет</option>
					<option value='1'>Да</option>
				</select>
...
foreach($arUsersGroups as $key => $group)
{
	...
	echo "<div style='width: 15%'><a href='#' class='info'>".($group['caption']!='' ? $group['caption']: '')."</a><input type='text' name='caption'/></div>";
	...
	echo "<div style='width: 6%;'><a href='#law_4_1_select' class='info color' data-id='".$group['law4_1']."'>".($group['law4_1']== 1 ? "Да":"Нет")."</a><input type='hidden' name='law4_1' value=''/></div>";
