...
if($law7 || $law9)
{
	...
	if($law9)
	{
		...
		echo "<div class='separ'></div>";
		echo "<a class='line-item lnk' data-type='109'>Обращения в тех. поддержку<i class='icon-external-link'></i></a>";
		echo "<div class='separ'></div>";
	...
	echo "<div class='separ'></div>";
	echo "<div class='line-option'><div class='capt wth80' title=''>Не выводить номер сообщения и доп. информацию у каждого маркера на карте</div><div class='action checkbox'><a href='#' class='icon-check ".(isset($userOptions[2]) ? 'active':'')."' data-option-id='2'></a></div></div>";
	if($law9)
	{
		echo "<div class='separ'></div>";
