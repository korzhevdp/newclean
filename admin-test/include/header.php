...
<head>
  ...
  <title>Чистый город</title>
	...
	<link rel="stylesheet" href="../admin-test/styles/style.css?v=2.6">
	<link rel="stylesheet" href="../styles/icons/icons.css?v=1.3">
	<link href="../plugins/mcustomscrollbar/mCustomScrollbar.css" rel="stylesheet">
	<link href="../plugins/hint/globalHint.css" rel="stylesheet">
	<link rel="stylesheet prefetch" href="../plugins/jdatepicker/jquery.simple-dtpicker.css">
</head>
<body>
